...
export default class ModuleConfig {
	constructor(namespace){
		...
		this.selectors = (selectors) => {
			if(selectors) 
				Object.assign(module.selectors, applyNamespaceToAll(namespace, selectors));
			return this;
		}
		...
		this.reducers = (reducers) => {
			if(reducers) 
				Object.assign(module.reducers, reducers);
			return this;
		}

		this.actionTypes = (actionTypes) => {
			if(actionTypes) 
				Object.assign(module.actionTypes, actionTypes);
			return this;
		}
